...
# KONFIG
DURATION_SEC = 60.0  # ta opp litt mer enn du tror du trenger
...
def main():
    ...
    print(f"Tar opp {DURATION_SEC:.1f}s fra Reachy Mini...")
    ...
    if voiced.size < TARGET_SR * 0.2:
        print("Fant nesten ingen tale. (Sjekk mic-permissions / input level)")
        print("TRANSKRIPT: ")
        print("")
        return

    print(f"S-T-T ({WHISPER_MODEL}, {COMPUTE_TYPE})...")
